...
if __name__ == '__main__':
    ...
    # cv2.imwrite("text_out.jpg", rotate, [int(cv2.IMWRITE_PNG_COMPRESSION), 0])
    cv2.waitKey(0)
...
参考资料1：[OpenCV-Python的文本透视矫正与水平矫正](https://blog.csdn.net/u013063099/article/details/81937848)